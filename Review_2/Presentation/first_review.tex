...
\begin{frame}{20. FOC vs CCS-MPC: Direct Overlay Comparison with 60\% load}
    \centering
...
\begin{frame}{74. Comprehensive Benchmark Summary: FOC vs. CCS-MPC Across Load Envelope}
    \centering
    \footnotesize\textbf{Full Summary Table (Base Torque = -250 Nm, Speed = 800 rad/s, Sim Time = 0.6s)}
    \vspace{1mm}
    ...
    \vspace{1.5mm}
    \begin{block}{Grand Benchmark Takeaways}
        \tiny
