...
\begin{frame}{13. Cost Estimate of the Project}
    ...
    \begin{tabular}{l l r}
        \toprule
        \textbf{Item} & \textbf{Purpose} & \textbf{Approx. Cost (INR)} \\
        \midrule
        ...
        \midrule
        \textbf{Estimated Total} & & \textbf{INR 8,000 -- 14,000} \\
        \bottomrule
    \end{tabular}
    \vspace{0.3cm}
...
\begin{frame}{15. References (IEEE Format)}
    ...
    \begin{thebibliography}{10}
        ...
        \bibitem{10} M. Gierczy\'nski and L. M. Grzesiak, ``Comparative Analysis of the Steady-State Model Including Non-Linear Flux Linkage Surfaces and the Simplified Linearized Model when Applied to a Highly-Saturated Permanent Magnet Synchronous Machine---Evaluation Based on the Example of the BMW i3 Traction Motor,'' \textit{Energies}, vol. 14, no. 9, art. 2343, 2021.
    \end{thebibliography}
\end{frame}
...
\begin{frame}{16b. System Parameters (Plant \& Controller)}
    ...
    \begin{columns}[T]
        ...
        \textit{\scriptsize Standard Application: BMW i3 Traction Motor (EV) \cite{10}}
        \vspace{1mm}
...
\begin{frame}{17b. FOC Simulation Results -- Constant Speed: Switching \& Speed}
    ...
    \vspace{2mm}
    \begin{itemize}
        \item \textbf{Speed Response:} The FOC speed response settles around the $318.3\text{ RPM}$ reference ($200\text{ rad/s}$ electrical) after an initial overshoot, with steady switching action from the SVPWM stage.
    \end{itemize}
\end{frame}
...
\begin{frame}{19b. CCS-MPC Simulation Results -- Constant Speed: Switching \& Speed}
    ...
    \vspace{2mm}
    \begin{itemize}
        \item \textbf{Tight Speed Regulation:} The CCS-MPC speed loop reaches $318.3\text{ RPM}$ reference ($200\text{ rad/s}$ electrical) quickly and settles into a tight steady-state band with regular 3-phase switching.
    \end{itemize}
\end{frame}
...
\begin{frame}{20. FOC vs CCS-MPC: Varying Load Comparison}
    \centering
    \footnotesize\textbf{Summary Table (Base Torque = -250 Nm, Speed = 1273.2 RPM (800 rad/s electrical), Sim Time = 0.6s)}
    \vspace{1mm}
    ...
    \begin{tabular}{c l c c c c c c c c c}
        ...
        \midrule
        \rowcolor{blue!5} 
        \textbf{100} & \textbf{CCS-MPC} & 801.1968 & 0.3599 & 0.4419 & \textbf{0.1496} & 45.0467 & \textbf{57.8963} & \textbf{89.2013} & \textbf{10.7042} & \textbf{1.0047} \\
                     & FOC              & 807.7869 & 0.3548 & 0.4472 & 0.9734 & 47.8207 & 58.6633 & 280.2387 & 33.6286 & 13.3310 \\
        \midrule
        \rowcolor{blue!5} 
        \textbf{80}  & \textbf{CCS-MPC} & 801.1710 & 0.3599 & 0.4416 & \textbf{0.1464} & 44.4877 & \textbf{57.4289} & \textbf{77.1475} & \textbf{9.2577} & \textbf{1.8818} \\
                     & FOC              & 806.7453 & 0.3550 & 0.4450 & 0.8432 & 47.1661 & 58.4969 & 268.9937 & 32.2792 & 28.2914 \\
        \midrule
        \rowcolor{blue!5} 
        \textbf{60}  & \textbf{CCS-MPC} & 801.2991 & 0.3598 & 0.4414 & \textbf{0.1624} & 44.4882 & \textbf{57.4287} & \textbf{94.2956} & \textbf{11.3155} & \textbf{3.1891} \\
                     & FOC              & 805.9658 & 0.3553 & 0.4430 & 0.7457 & 46.4910 & 57.9538 & 253.6331 & 30.4360 & 23.2509 \\
        \midrule
        \rowcolor{blue!5} 
        \textbf{50}  & \textbf{CCS-MPC} & 801.3479 & 0.3598 & 0.4415 & \textbf{0.1685} & 44.4885 & \textbf{57.4287} & \textbf{93.4703} & \textbf{11.2164} & \textbf{3.0972} \\
                     & FOC              & 805.2953 & 0.3561 & 0.4431 & 0.6619 & 45.8946 & 58.4370 & 265.6205 & 31.8745 & 22.6466 \\
        \midrule
        \rowcolor{blue!5} 
        \textbf{20}  & \textbf{CCS-MPC} & 801.0333 & 0.3599 & 0.4415 & \textbf{0.1292} & 44.4890 & \textbf{57.4289} & \textbf{118.1778} & \textbf{14.1813} & \textbf{0.1741} \\
                     & FOC              & 804.9702 & 0.3596 & 0.4425 & 0.6213 & 45.0811 & 58.0787 & 237.2207 & 28.4665 & 1.7142 \\
        \midrule
        \rowcolor{blue!5} 
        \textbf{0}   & \textbf{CCS-MPC} & 801.2315 & 0.3595 & 0.4410 & \textbf{0.1539} & 44.4875 & \textbf{57.4277} & \textbf{132.0402} & \textbf{15.8448} & \textbf{0.2859} \\
                     & FOC              & 805.7548 & 0.3596 & 0.4413 & 0.7193 & 44.2470 & 58.0075 & 231.2172 & 27.7461 & 5.7255 \\
        \bottomrule
    \end{tabular}
    }
    ...
    \begin{block}{Load Condition Summary}
        \tiny
        \textbf{Heavy / Rated Load Performance (50--100\%):} CCS-MPC proves vastly superior, suppressing torque ripple by \textbf{$3.14\times$} ($10.70\text{ Nm}$ vs $33.63\text{ Nm}$ at 100\%) and $I_q$ ripple by \textbf{$3.49\times$} ($77.15\text{ A}$ vs $268.99\text{ A}$ at 80\%), while maintaining ultra-low THD ($1.00\%$ vs $13.33\%$). \\
        \textbf{Light / No-Load Performance (0--20\%):} CCS-MPC exhibits tight speed overshoot ($\le 0.15\%$ vs up to $0.72\%$) and superior harmonic suppression ($0.17\%$ vs $1.71\%$ THD at 20\% load).
    \end{block}
\end{frame}
...
\begin{frame}{21. Why We Need CCS-MPC (Load Analysis)}
    ...
    \begin{itemize}
        ...
        \item \textbf{Vastly Superior Current Tracking:} Across all load conditions, CCS-MPC suppresses $I_q$ ripple by a massive margin. At 100\% load, $I_q$ ripple is reduced by \textbf{$3.14\times$} (89.20 A vs 280.24 A), proving the analytic deadbeat optimizer isolates electrical noise far better than cascaded PI loops.
        \item \textbf{Major Torque Ripple Suppression:} Torque ripple is strictly minimized across the entire torque envelope. At 80\% load, CCS-MPC reduces torque ripple by \textbf{$3.49\times$} (9.26 Nm vs 32.28 Nm), which directly eliminates acoustic whine and reduces gearbox torsional wear.
        \item \textbf{Superior Speed Regulation \& Lower Overshoot:} Across all operating loads, CCS-MPC maintains speed overshoot below \textbf{$0.17\%$} (1275.3 RPM max), whereas FOC exhibits up to \textbf{$0.97\%$} overshoot (1285.7 RPM peak).
        \item \textbf{Dramatic THD Reduction:} At 100\% load, current THD is reduced by over \textbf{$13\times$} ($1.00\%$ for CCS-MPC vs $13.33\%$ for FOC), significantly lowering stator harmonic copper losses and thermal rise.
        \item \textbf{Zero Manual Gain Tuning:} Achieving these high-stability current and torque margins requires zero manual PI gain calibration; the controller synthesizes deadbeat voltages directly from identified machine parameters ($\hat{R}_s, \hat{L}_d, \hat{L}_q, \hat{\Psi}_{PM}$).
    \end{itemize}
\end{frame}
...
\begin{frame}{23. Methodology: Mechanical Parameter \& Flux Estimation (Phase 2)}
    \begin{itemize}
        ...
        \begin{itemize}
            \item Spins motor open-loop past minimum threshold speed $\omega_{min} = 1273.2\text{ RPM}$ ($800\text{ rad/s}$ electrical).
        ...
        \begin{itemize}
            \item Regulates closed-loop mechanical speeds to $\omega_1 = 573\text{ RPM}$ and $\omega_2 = 1146\text{ RPM}$ ($60\text{ rad/s}$ and $120\text{ rad/s}$) with strict $1.5\text{ s}$ settling timers.
...
\begin{frame}{26. Strategy of Auto-Tuning: 7.0-Second Sequence (Part 2)}
    \begin{itemize}
        ...
        \begin{itemize}
            \item Spins motor past $1273.2\text{ RPM}$ ($800\text{ rad/s}$ electrical); cuts off current and integrates Back-EMF decay, latching $\hat{\Psi}_{PM} = 0.0436\text{ Wb}$ at $t = 3.90\text{ s}$.
        \end{itemize}
        \item \textbf{State 5: Two-Point Friction \& Active Braking Inertia Extraction ($3.9\text{ s} \le t < 7.05\text{ s}$):}
        \begin{itemize}
            \item Settles at $573\text{ RPM}$ ($60\text{ rad/s}$, $3.9 - 5.4\text{ s}$) and $1146\text{ RPM}$ ($120\text{ rad/s}$, $5.4 - 6.95\text{ s}$), latching $\hat{B} = 0.0010\text{ Nms/rad}$ at $t = 6.95\text{ s}$.
...
\begin{frame}
    \centering
    \vfill
    {\Large \textbf{Self-Commissioning Drive for PMSM using CCS-MPC with prognostics using Artificial Intelligence}\par}
    \vspace{6mm}
    {\Huge \textbf{Review-2}\par}
    \vfill
\end{frame}
...
\begin{frame}{28a. Benchmark Motor Parameters: BMW i3 Traction IPMSM}
    \vspace{-1mm}
    \begin{columns}[T]
        \column{0.50\textwidth}
        \textbf{\footnotesize Electrical Machine Parameters} \\
        \vspace{1mm}
        \resizebox{\linewidth}{!}{%
        \renewcommand{\arraystretch}{1.12}
        \begin{tabular}{llc}
            \toprule
            \textbf{Parameter Name} & \textbf{Symbol} & \textbf{Nominal Value} \\
            \midrule
            \rowcolor{blue!5} Stator Resistance & $R_s$ & $5.30\text{ m}\Omega\ (0.0053\ \Omega)$ \\
            $d$-axis Inductance & $L_d$ & $71.20\ \mu\text{H}\ (0.0712\text{ mH})$ \\
            \rowcolor{blue!5} $q$-axis Inductance & $L_q$ & $141.30\ \mu\text{H}\ (0.1413\text{ mH})$ \\
            Saliency Ratio & $\xi = L_q/L_d$ & $1.984\approx 2.0$ (High Saliency) \\
            \rowcolor{blue!5} PM Flux Linkage & $\Psi_{PM}$ & $0.0436\text{ Wb}\ (43.6\text{ mWb})$ \\
            Pole Pairs & $p$ & $6$ ($12\text{ poles}$) \\
            \rowcolor{blue!5} Torque Constant & $K_t$ & $0.3924\text{ N}\cdot\text{m/A}$ \\
            Rotor Inertia & $J$ & $0.0867\text{ kg}\cdot\text{m}^2$ \\
            \rowcolor{blue!5} Viscous Friction & $B$ & $0.001\text{ N}\cdot\text{m}\cdot\text{s/rad}$ \\
            \bottomrule
        \end{tabular}%
        }

        \column{0.50\textwidth}
        \textbf{\footnotesize Operational Ratings \& Inverter Interface} \\
        \vspace{1mm}
        \resizebox{\linewidth}{!}{%
        \renewcommand{\arraystretch}{1.12}
        \begin{tabular}{llc}
            \toprule
            \textbf{Specification} & \textbf{Symbol} & \textbf{Rated Limit} \\
            \midrule
            \rowcolor{blue!5} Maximum Mechanical Power & $P_{max}$ & $108.2\text{ kW}$ ($104.7\text{ kW}$ @ $250\text{ Nm}$) \\
            Maximum Peak Torque & $T_{max}$ & $250.0\text{ N}\cdot\text{m}$ (Tested $100\%$) \\
            \rowcolor{blue!5} Base Operating Speed & $n_{base}$ & $4{,}000\text{ RPM}\ (418.9\text{ rad/s})$ \\
            Maximum FW Speed & $n_{max}$ & $11{,}400\text{ RPM}\ (1193.8\text{ rad/s})$ \\
            \rowcolor{blue!5} Peak Phase Current & $I_{max}$ & $565.68\text{ A}\ (400.0\text{ A}_{rms})$ \\
            Nominal DC Bus Voltage & $V_{dc}$ & $400.0\text{ V}$ \\
            \rowcolor{blue!5} Inverter Switching Freq. & $f_{sw}$ & $10.0\text{ kHz}\ (T_{sw} = 100\ \mu\text{s})$ \\
            Control Sample Time & $T_{s,ctrl}$ & $100\ \mu\text{s}\ (10\text{ kHz})$ \\
            \rowcolor{blue!5} Simulation Base Step & $T_{s,sim}$ & $5\ \mu\text{s}\ (200\text{ kHz})$ \\
            \bottomrule
        \end{tabular}%
        }
    \end{columns}
    \vspace{2mm}
    \centering
    \tiny \textbf{Parameter \& Steady-State Model Reference:} M. Gierczy\'nski and L. M. Grzesiak, ``Comparative Analysis of the Steady-State Model Including Non-Linear Flux Linkage Surfaces and the Simplified Linearized Model when Applied to a Highly-Saturated Permanent Magnet Synchronous Machine---Evaluation Based on the Example of the BMW i3 Traction Motor,'' \textit{Energies}, vol. 14, no. 9, art. 2343, 2021.
\end{frame}

\begin{frame}{29. Overall Self-Commissioning Cascaded Control Architecture}
    \centering
    \vspace{2mm}
    \resizebox{0.96\textwidth}{!}{%
    \begin{tikzpicture}[
        ctrl/.style = {rectangle, draw=blue!80!black, line width=1.2pt, fill=blue!10, rounded corners=4pt, align=center, font=\footnotesize\bfseries, minimum height=1.1cm, text width=2.1cm},
        plant/.style = {rectangle, draw=black!80, line width=1.2pt, fill=gray!20, rounded corners=4pt, align=center, font=\footnotesize\bfseries, minimum height=1.1cm, text width=2.0cm},
        tuner/.style = {rectangle, draw=orange!90!black, line width=1.3pt, fill=orange!12, rounded corners=4pt, align=center, font=\small\bfseries, minimum height=1.05cm, text width=5.4cm},
        sensor/.style = {rectangle, draw=teal!80!black, line width=1.1pt, fill=teal!10, rounded corners=3pt, align=center, font=\scriptsize\bfseries, minimum height=0.8cm, text width=2.2cm},
        fwd/.style = {->, >=Stealth, line width=1.2pt, draw=blue!75!black},
        tune/.style = {->, >=Stealth, line width=1.1pt, draw=orange!85!black},
        fbi/.style = {->, >=Stealth, line width=1.0pt, draw=red!70!black, dashed},
        fbw/.style = {->, >=Stealth, line width=1.0pt, draw=teal!70!black, dashed}
    ]
        % ================= FORWARD PATH (y = 0) =================
        \node[ctrl] (sp) at (-2.4, 0) {Speed MPC\\{\tiny (1 kHz Discrete)}};
        \node[ctrl] (cc) at (1.4, 0) {CCS-MPC\\{\tiny (10 kHz Current)}};
        \node[ctrl] (pwm) at (4.9, 0) {SVPWM\\{\tiny (10 kHz Switching)}};
        \node[plant] (inv) at (8.1, 0) {2-Level VSI\\{\tiny ($V_{dc} = 400\text{ V}$)}};
        \node[plant] (pmsm) at (11.4, 0) {IPMSM Plant\\{\tiny (BMW i3 Machine)}};

        % Forward Signal Flow
        \draw[fwd] (-4.3, 0) -- node[above, font=\footnotesize\bfseries] {$\omega_{ref}$} (sp.west);
        \draw[fwd] (sp.east) -- node[above, font=\footnotesize\bfseries] {$i_{dq,ref}$} (cc.west);
        \draw[fwd] (cc.east) -- node[above, font=\footnotesize\bfseries] {$v_{dq}^*$} (pwm.west);
        \draw[fwd] (pwm.east) -- node[above, font=\footnotesize\bfseries] {$S_{abc}$} (inv.west);
        \draw[fwd] (inv.east) -- node[above, font=\footnotesize\bfseries] {$i_{abc}$} (pmsm.west);

        % ================= AUTOTUNER LAYER (y = 2.2) =================
        \node[tuner] (tuner) at (1.4, 2.2) {\textbf{Autonomous Parameter AutoTuner}\\{\scriptsize 7.0 s Sequence: Standstill DC/AC \& Spin-Up}};

        % AutoTuner Outputs: Dedicated orthogonal paths
        \draw[tune] (tuner.west) -| node[pos=0.4, above, font=\scriptsize\bfseries] {$\hat{J}, \hat{B},\ \omega_{ref,out}$} (sp.north);
        \draw[tune] (tuner.south) -- node[right, font=\scriptsize\bfseries] {$\hat{R}_s, \hat{L}_d, \hat{L}_q, \hat{\Psi}_{PM}$} (cc.north);
        \draw[tune] (tuner.east) -| node[pos=0.4, above, font=\scriptsize\bfseries] {\texttt{ctrl\_mode} ($0/1$)} (pwm.north);

        % ================= SENSORY FEEDBACK TO AUTOTUNER (Top Highway: y = 3.2) =================
        \draw[fbw] (pmsm.north) |- (11.4, 3.1) -- node[above, font=\scriptsize\bfseries] {Sensory Feedback for AutoTuning ($i_{abc}, \theta_e, \omega_m$)} (1.4, 3.1) -- (tuner.north);

        % ================= CURRENT FEEDBACK (Lane 1: y = -1.3) =================
        \node[sensor] (cp) at (1.4, -1.3) {Clarke / Park\\{\tiny Transform}};
        \draw[fbi] (9.75, 0) |- node[pos=0.6, above, font=\scriptsize\bfseries] {Current Feedback ($i_{abc}$)} (cp.east);
        \draw[fwd] (cp.north) -- node[right, font=\scriptsize\bfseries] {$i_d, i_q$} (cc.south);

        % ================= SPEED & ANGLE FEEDBACK (Lane 2: y = -2.3) =================
        \draw[fbw] (pmsm.south) -- (11.4, -2.3) -- node[pos=0.35, above, font=\scriptsize\bfseries] {Rotor Position ($\theta_e$)} (1.4, -2.3) -- (cp.south);
        \draw[fbw] (1.4, -2.3) -- node[pos=0.55, above, font=\scriptsize\bfseries] {Rotor Speed ($\omega_m$)} (-2.4, -2.3) -- (sp.south);
    ...
    \begin{itemize}
        \small
        \item \textbf{Decoupled Multi-Rate Architecture:} AutoTuner delivers identified motor constants prior to drive enable; Speed MPC ($1\text{ kHz}$) regulates mechanical dynamics; Inner CCS-MPC ($10\text{ kHz}$) synthesizes deadbeat voltages; Space Vector PWM switches the inverter with zero cross-talk.
    \end{itemize}
\end{frame}

\begin{frame}{29a. Standalone AutoTuner Subsystem}
    \centering
    \vspace{2mm}
...
\begin{frame}{30. AutoTuner Result: Modulating Duty Cycle ($d_a$) Full Profile \& Zoom}
    \centering
    \begin{columns}
        \column{0.50\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=0.48\textheight,keepaspectratio]{AutoTuner_MIL_vs_SIL_da.png}
        \column{0.50\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=0.48\textheight,keepaspectratio]{AutoTuner_MIL_vs_SIL_da_Zoomed.png}
    \end{columns}
    \vspace{2mm}
    \begin{itemize}
        \footnotesize
...
\begin{frame}{33. AutoTuner Result: $d$-axis Inductance ($L_d$) Estimation}
    \centering
...
\begin{frame}{34. AutoTuner Result: $q$-axis Inductance ($L_q$) Estimation}
    \centering
...
\begin{frame}{35. AutoTuner Result: PM Flux Linkage ($\Psi_{PM}$) Estimation}
    \centering
...
\begin{frame}{36. AutoTuner Result: Viscous Friction ($B$) Estimation}
    \centering
    ...
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{2pt}
        \item \textbf{Two-Point Speed Evaluation:} Steps from 0 to identified $B = 0.00012\text{ N}\cdot\text{m}\cdot\text{s/rad}$ at $t = 6.95\text{ s}$ following the $573\text{ RPM}$ and $1146\text{ RPM}$ ($60\text{ rad/s}$ and $120\text{ rad/s}$) speed holds.
        \item \textbf{Ripple Rejection:} Multi-sample torque averaging completely filters out inverter switching ripple.
    \end{itemize}
\end{frame}

\begin{frame}{37. AutoTuner Result: Rotor Inertia ($J$) Estimation}
    \centering
...
\begin{frame}{38. AutoTuner Result: Speed Setpoint Output ($N_{ref,out}$ [RPM])}
    \centering
    ...
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{2pt}
        \item \textbf{Supervisory Trajectory Output:} Holds speed reference at zero during autonomous tuning ($0 - 7.05\text{ s}$), then transparently passes external speed commands ($1273.2\text{ RPM}$) for $t \ge 7.05\text{ s}$.
        \item \textbf{Anti-Windup Protection:} Integrator gating prevents startup transients upon closed-loop engagement.
    \end{itemize}
\end{frame}

\begin{frame}{39. AutoTuner: Deep Engineering Inferences}
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{3pt}
...
\begin{frame}{47. Speed MPC Result: Speed Tracking Profile ($N$ [RPM])}
    \centering
    ...
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{2pt}
        \item \textbf{Multi-Regime Speed Trajectory ($0 - 2.5\text{ s}$ Timeline in RPM):} Base speed MTPA ramp ($0 \rightarrow 3979\text{ RPM}$ at $t=0.6\text{ s}$), field-weakening acceleration ($3979 \rightarrow 8754\text{ RPM}$ at $t=1.7\text{ s}$), and regenerative braking deceleration ($8754 \rightarrow 2387\text{ RPM}$ at $t=2.5\text{ s}$).
        \item \textbf{Tracking Precision:} Actual rotor speed $N$ (solid blue) tracks reference $N_{ref}$ (dashed black) with high dynamic fidelity and zero overshoot.
    \end{itemize}
\end{frame}

\begin{frame}{48. Speed MPC Result: Speed Tracking Error ($e_{RPM} = N_{ref} - N_{meas}$)}
    \centering
    ...
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{2pt}
        \item \textbf{Transient Error Dynamics ($0 - 2.5\text{ s}$):} Error peaks briefly ($\approx 86.7\text{ RPM}$) during steep acceleration transitions.
    \end{itemize}
\end{frame}
...
\begin{frame}{49. Speed MPC Result: Torque Reference Current ($i_{q,ref}$)}
    ...
    \begin{itemize}
        ...
        \item \textbf{MIL vs. SIL Parity:} Generated ANSI C99 firmware replicates Simulink commands with \textbf{Max Error: 5.68e-14 A}.
    \end{itemize}
\end{frame}

\begin{frame}{50. Speed MPC Result: Demagnetizing Current ($i_{d,ref}$)}
    \centering
...
\begin{frame}{54. Inner CCS-MPC: Predictive Current State-Space Model}
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{2pt}
        \item \textbf{Continuous Machine Equations in Synchronous d-q Frame \cite{10}:}
        \begin{align}
    ...
    \vspace{1mm}
    \centering
    \tiny \textit{Machine dynamics formulation reference: M. Gierczy\'nski and L. M. Grzesiak, Energies, vol. 14, no. 9, 2021 \cite{10}.}
\end{frame}

\begin{frame}{54a. Physical Current Ripple Justification \& Theoretical Limits}
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{3pt}
        \item \textbf{Origin of Physical Inverter Switching Ripple ($\Delta I_L$):}
        When a 2-level Space Vector PWM inverter applies chopped DC link pulses ($V_{dc} = 400\text{ V}$) across discrete inductive motor windings at switching frequency $f_{sw} = 10\text{ kHz}$, the inductor current ramps up and down according to Faraday's Law ($v_L = L \frac{di}{dt}$).
        \item \textbf{Theoretical Peak-to-Peak High-Frequency Current Ripple Formula:}
        \begin{equation}
            \Delta I_L = \Delta I_{pk-pk} = \frac{V_{dc}}{4 \cdot f_{sw} \cdot L}
        \end{equation}
        \item \textbf{Theoretical Axis-Specific Limits for BMW i3 IPMSM:}
        \begin{itemize}
            \footnotesize
            \item \textbf{$q$-axis Ripple ($L_q = 141.30\ \mu\text{H}$):} $\Delta I_{Lq,max} = \frac{400\text{ V}}{4 \times 10{,}000\text{ Hz} \times 141.30 \times 10^{-6}\text{ H}} = \mathbf{70.77\text{ A}_{pk-pk}} \quad (\pm 35.39\text{ A})$
            \item \textbf{$d$-axis Ripple ($L_d = 71.20\ \mu\text{H}$):} $\Delta I_{Ld,max} = \frac{400\text{ V}}{4 \times 10{,}000\text{ Hz} \times 71.20 \times 10^{-6}\text{ H}} = \mathbf{140.45\text{ A}_{pk-pk}} \quad (\pm 70.22\text{ A})$
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{55. CCS-MPC Result: Dynamic $q$-axis Current Tracking ($i_q$)}
    \centering
    \includegraphics[height=0.49\textheight,keepaspectratio]{CCSMPC_Tracking_iq.png}
    \vspace{1mm}
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{1.5pt}
        \item \textbf{100\% Maximum Rated Torque Dynamic Step ($0 \to 467.07\text{ A}$):} Authentic closed-loop Simulink model step response to full rated load torque ($250.0\text{ Nm}$) commanded at $t = 0.05\text{ s}$ by the outer speed loop and MTPA algorithm.
        \item \textbf{Rapid Deadbeat Dynamic Tracking:} Quadrature stator current rises and settles completely within $< 15\text{ ms}$ with zero overshoot and robust stability under full magnetic saturation.
    \end{itemize}
\end{frame}
...
\begin{frame}{56. CCS-MPC Result: $q$-axis Current Tracking Error ($\Delta i_q$)}
    ...
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{2pt}
        \item \textbf{Full Step Transient (Top Subplot):} Unclipped dynamic response shows the full $465\text{ A}$ step transient error at $t = 0.05\text{ s}$ converging deadbeat to zero in $< 3\text{ ms}$.
        \item \textbf{Settled Steady-State Zoom (Bottom Subplot):} Magnified view of settled tracking shows mean steady-state error $e_{ss} = +4.34\text{ A}$ (\textbf{99.1\% accuracy} at $467.07\text{ A}$ rated current) with ripple bounded within $\pm 3.9\text{ A}$.
    \end{itemize}
\end{frame}
...
\begin{frame}{57. CCS-MPC Result: Dynamic $d$-axis Current Tracking ($i_d$)}
    ...
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{2pt}
        \item \textbf{MTPA Reluctance Torque Allocation ($0 \to -254.25\text{ A}$):} Direct-axis demagnetizing current dynamically commanded at $t = 0.05\text{ s}$ to maximize reluctance torque, producing a $531.7\text{ A}$ total stator current vector for $250\text{ Nm}$ peak torque.
        \item \textbf{Cross-Axis Decoupling \& Full Settling:} Direct axis tracks the negative step within $< 15\text{ ms}$ with complete decoupling from the simultaneously applied $467\text{ A}$ quadrature step.
    \end{itemize}
\end{frame}
...
\begin{frame}{58. CCS-MPC Result: $d$-axis Current Tracking Error ($\Delta i_d$)}
    ...
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{2pt}
        \item \textbf{Full Step Transient (Top Subplot):} Unclipped dynamic response shows the full $-245\text{ A}$ demagnetization step error at $t = 0.05\text{ s}$ converging deadbeat to zero in $< 3\text{ ms}$.
        \item \textbf{Settled Steady-State Zoom (Bottom Subplot):} Magnified view of settled demagnetization shows mean error $e_{ss} = -7.03\text{ A}$ (\textbf{97.3\% accuracy} at $-254.25\text{ A}$ MTPA bias) with ripple bounded within $\pm 10.0\text{ A}$.
    \end{itemize}
\end{frame}
...
\begin{frame}{67. MTPA / MTPV Operating Envelope \& Capability Profiles}
    ...
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{2pt}
        \item \textbf{Panel 1 (Left):} Uncluttered $(i_d, i_q)$ vector plane showing Region I MTPA locus (red), Region II FW arc along $I_{max}$ (blue), Region III MTPV trajectory (purple), voltage ellipses ($4000, 8500, 11400\text{ RPM}$), and rated Point A ($-239.0\text{ A}, 512.7\text{ A}$).
...
\begin{frame}{68. MTPA / MTPV Operating Regions \& Transition Criteria}
    ...
    \begin{tabular}{l l l l}
        \toprule
        \textbf{Region} & \textbf{Speed Range} & \textbf{Active Limit} & \textbf{Control Strategy} \\
        \midrule
        \rowcolor{blue!5} \textbf{Region I (MTPA)} & $0 \le n \le 4000\text{ RPM}$ & Current ($I_{max}$) & Follows MTPA locus; delivers $258.2\text{ N}\cdot\text{m}$ rated torque ($0 \rightarrow 108.2\text{ kW}$). \\
        \textbf{Region II (FW)} & $4000 < n \le 8500\text{ RPM}$ & Voltage \& Current & Follows $I_{max}$ circle arc; delivers flat $108.2\text{ kW}$ constant power ($T_e \propto 1/\omega_m$). \\
        \rowcolor{blue!5} \textbf{Region III (MTPV)} & $8500 < n \le 11400\text{ RPM}$ & Voltage ($V_{max}$) & Enters circle along MTPV path toward $(-\Psi_{PM}/L_d, 0)$ to sustain maximum torque. \\
        \bottomrule
    \end{tabular}%
    }
    \vspace{3mm}
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{2pt}
        \item \textbf{Reluctance Optimization:} MTPA utilizes machine saliency, reducing current demand by $\approx 22\%$ at rated torque.
        \item \textbf{Extended Speed Range:} 3-region envelope provides seamless control from standstill to $11{,}400\text{ RPM}$.
    \end{itemize}
\end{frame}
...
\begin{frame}{71. Master Verification Summary: Complete MIL vs. SIL Equivalence}
    \centering
    \footnotesize
    \textbf{Summary of All Verified Signals across Standalone Modules \& Tracking Loops ($T_s = 5\ \mu\text{s}$, Rate = $10\text{ kHz}$)}
    \vspace{1mm}
    \resizebox{0.92\textwidth}{!}{%
    \renewcommand{\arraystretch}{0.90}
    \begin{tabular}{l l c c c c}
        \toprule
        \textbf{Module} & \textbf{Verified Signal / State} & \textbf{Unit} & \textbf{Max Abs Error} & \textbf{RMSE / Ripple} & \textbf{Fidelity Status} \\
        \midrule
        ...
        \rowcolor{blue!5} \textbf{AutoTuner} & Modulating Duties ($d_a, d_b, d_c$) & p.u. & \textbf{3.33e-16} & \textbf{1.26e-17} & \textbf{Epsilon Match} \\
        \textbf{AutoTuner} & Control Mode Flag (\texttt{ctrl\_mode}) & --- & \textbf{0.00e+00} & \textbf{0.00e+00} & \textbf{Bit-Exact Match} \\
        \rowcolor{blue!5} \textbf{AutoTuner} & Speed Setpoint Output ($N_{ref,out}$) & RPM & \textbf{0.00e+00} & \textbf{0.00e+00} & \textbf{Bit-Exact Match} \\
        \midrule
        \textbf{Speed MPC} & Mechanical Speed Tracking ($N$) & RPM & \textbf{0.00e+00} & \textbf{0.00e+00} & \textbf{Bit-Exact Match} \\
        \rowcolor{blue!5} \textbf{Speed MPC} & Dynamic Torque Current Ref ($i_{q,ref}$) & A & \textbf{1.14e-13} & \textbf{2.45e-14} & \textbf{Epsilon Match} \\
        \textbf{Speed MPC} & Demag / Reluctance Current Ref ($i_{d,ref}$) & A & \textbf{1.14e-13} & \textbf{3.12e-14} & \textbf{Epsilon Match} \\
        \midrule
        \rowcolor{blue!5} \textbf{CCS-MPC} & Direct Optimal Voltage ($v_{d,ref}$) & V & \textbf{0.00e+00} & \textbf{0.00e+00} & \textbf{Bit-Exact Match} \\
        \textbf{CCS-MPC} & Quadrature Optimal Voltage ($v_{q,ref}$) & V & \textbf{0.00e+00} & \textbf{0.00e+00} & \textbf{Bit-Exact Match} \\
        \rowcolor{blue!5} \textbf{CCS-MPC} & Modulating Duties ($d_a, d_b, d_c$) & p.u. & \textbf{0.00e+00} & \textbf{0.00e+00} & \textbf{Bit-Exact Match} \\
        \textbf{CCS-MPC} & Inverter Gate Pulses ($S_a, S_b, S_c$) & $\{0, 1\}$ & \textbf{0.00e+00} & \textbf{0.00e+00} & \textbf{Bit-Exact Match} \\
        \rowcolor{blue!5} \textbf{CCS-MPC} & Dynamic $q$-axis Tracking ($i_q \le 460\text{ A}$) & A & \textbf{0.00e+00} & Ripple $35.83\text{ A}_{pp}$ & \textbf{Verified ($\le \Delta I_{Lq}$)} \\
        \textbf{CCS-MPC} & Dynamic $d$-axis Tracking ($i_d \ge -240\text{ A}$) & A & \textbf{0.00e+00} & Ripple $64.55\text{ A}_{pp}$ & \textbf{Verified ($\le \Delta I_{Ld}$)} \\
        \bottomrule
    \end{tabular}%
    }
    \vspace{1.5mm}
    \begin{itemize}
        \footnotesize
        \setlength{\itemsep}{1.5pt}
        \item \textbf{Bit-Exact MIL vs. SIL Equivalence:} $100\%$ determinism verified between Simulink and Embedded Coder ANSI C99 firmware across all standalone control modules.
        \item \textbf{Physical Tracking Conformity:} Closed-loop currents track zero-mean reference under full $250\text{ N}\cdot\text{m}$ load, bounded strictly below theoretical inverter ripple limits ($\Delta I_{Lq,max} = 70.8\text{ A}_{pp}$, $\Delta I_{Ld,max} = 140.5\text{ A}_{pp}$).
    \end{itemize}
\end{frame}

\begin{frame}{72. Hardware-in-the-Loop (HIL) Testbed \& Review-3 Roadmap}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Code Generation:} ANSI C99 production code generated via Embedded Coder and verified in SIL co-simulation.
        \end{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Milestone 2 (AI Prognostics):} Deploy 1D-CNN fault classification model on Raspberry Pi 4.
        \end{itemize}
    \end{itemize}
\end{frame}

\begin{frame}{73. Mathematical Formulations \& Literature References}
    \tiny
    \begin{thebibliography}{10}
        \setlength{\itemsep}{2.5pt}
        \bibitem{ref_gierczynski} M. Gierczy\'nski and L. M. Grzesiak, ``Comparative Analysis of the Steady-State Model Including Non-Linear Flux Linkage Surfaces and the Simplified Linearized Model when Applied to a Highly-Saturated Permanent Magnet Synchronous Machine---Evaluation Based on the Example of the BMW i3 Traction Motor,'' \textit{Energies}, vol. 14, no. 9, art. 2343, 2021. \hfill \textit{[Eqs: Machine Dynamics, Saturation Curves, MTPA/MTPV Profiles]}
        
        \bibitem{ref_hammoud} I. Hammoud, M. B. Gaeta, and M. H. V. M. Ramos, ``On Continuous-Set Model Predictive Control of Permanent Magnet Synchronous Machines,'' \textit{IEEE Trans. Power Electron.}, vol. 37, no. 9, pp. 10424--10435, Sept. 2022. \hfill \textit{[Eqs: CCS-MPC Cost Function, Analytical Deadbeat Voltages, Circle Voltage Clamping]}
        
        \bibitem{ref_rafaq} M. S. Rafaq and J. Jung, ``A Comprehensive Review of State-of-the-Art Parameter Estimation Techniques for Permanent Magnet Synchronous Motors in Electric Vehicles,'' \textit{IEEE Trans. Ind. Inform.}, vol. 16, no. 7, pp. 4434--4448, 2020. \hfill \textit{[Eqs: Two-Level DC Injection for $R_s$, HF AC Injection for $L_d, L_q$, Back-EMF Coastdown for $\Psi_{PM}$]}
        
        \bibitem{ref_liu} Z. Liu \textit{et al.}, ``Global Identification of Electrical and Mechanical Parameters in PMSM Drive Based on Dynamic Self-Learning PSO,'' \textit{IEEE Trans. Power Electron.}, vol. 33, no. 12, pp. 10858--10871, 2018. \hfill \textit{[Eqs: Mechanical State-Space Dynamics, Viscous Friction $B$, Rotor Inertia $J$]}
        
        \bibitem{ref_holmes} D. G. Holmes and T. A. Lipo, \textit{Pulse Width Modulation for Power Converters: Principles and Practice}, IEEE Press / Wiley-Interscience, 2003. \hfill \textit{[Eqs: Inverter Switching Current Ripple $\Delta I_L = \frac{V_{dc}}{4 f_{sw} L}$, Space Vector PWM Modulation]}
        
        \bibitem{ref_morimoto} S. Morimoto, M. Sanada, and Y. Takeda, ``Expansion of operating limits for permanent magnet synchronous motor by optimum flux-weakening,'' \textit{IEEE Trans. Ind. Appl.}, vol. 26, no. 5, pp. 866--871, 1990. \hfill \textit{[Eqs: MTPA Trajectory, Deep Field-Weakening MTPV Locus, Voltage Limit Ellipses]}
    \end{thebibliography}
\end{frame}
